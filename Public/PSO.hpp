...
//public:
//	PsoDesc() = default;
//	PsoDesc(const std::string& name, IRenderProvider& provider) :
...
//	IRenderProvider* const shaderProvider = nullptr;
//
//	Shader* const getVS() {
//		if (!vs.empty() || vs != "") {
...
//
//	// Templates
//	static PsoDesc createBase2DPipeline(IRenderProvider& provider) {
...
//
//	using Set = uint32_t;
//	static ErrorCode createFromMaterial(IRenderProvider& provider, Material& material, PsoDesc& pso) {
